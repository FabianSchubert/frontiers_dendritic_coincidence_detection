...
files = os.listdir(os.path.join(DATA_DIR,"correlation_dimension_scaling_high_input_dim"))

data = []

for file in files:
    data.append(np.load(os.path.join(DATA_DIR,"correlation_dimension_scaling_high_input_dim/"+file)))
...
fig.savefig(os.path.join(PLOT_DIR,"corr_dimension_scaling_high_input_dim.pdf"))
fig.savefig(os.path.join(PLOT_DIR,"corr_dimension_scaling_high_input_dim.png"),dpi=600)
