...
folders = ["classification_dimension_scaling_high_input_dim"
,"classification_dimension_scaling_bcm_high_input_dim"]
...
fig.savefig(os.path.join(PLOT_DIR,"classification_dimension_scaling_high_input_dim_composite.pdf"))
fig.savefig(os.path.join(PLOT_DIR,"classification_dimension_scaling_high_input_dim_composite.png"),dpi=600)
